...
class QEinterpolator:
    def __init__(self, name=None, image_path=None, xmin=None, xmax=None, ymin=None, ymax=None):
        """
        Parameters
        ----------
        name : str, optional
    ...
    def click_points(self, x_spacing=50, y_spacing=0.1):
        ...
        ax.imshow(img, extent=[self.xmin, self.xmax, self.ymin, self.ymax], aspect='auto')
    ...
    def interpolate(self, wl_start=400, wl_end=1000, spacing=2.5, kind='cubic'):
        ...
        for color in ['r', 'g', 'b']:
            ...
            f = interpolate.interp1d(wl_raw, qe_raw, kind="cubic", 
    ...
    def save_csv(self, filename=None):
        ...
        data = np.column_stack([
            pad(self.raw_data['r'][0]), pad(self.raw_data['r'][1]),
            pad(self.raw_data['g'][0]), pad(self.raw_data['g'][1]),
            pad(self.raw_data['b'][0]), pad(self.raw_data['b'][1]),
            self.interp_data['wl'],
            self.interp_data['r'],
            self.interp_data['g'],
            self.interp_data['b']
